...
# === 1. Génération TTS + Mapping Timecodes ===
...
# === 2. Création piste audio silencieuse + insertion TTS ===
...
# === 5. Nettoyage fichiers audio temporaires ===
